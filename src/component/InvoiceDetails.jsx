...
function InvoiceDetails({ invoice }) {
    ...
    return (
        <div className="bg-[#0B192C] rounded-lg p-5">
            <div className="flex flex-col md:flex-row justify-between items-center mb-5 gap-5">
                <div className="flex item-center space-x-4">
                    ...
                    >
                        <div className={` mt-3 w-2 h-2 rounded-full ${invoice.status === "paid" ? "bg-green-500" : invoice.status === "pending" ? "bg-red-500" : "bg-slate-400"}`}></div>
                ...
                <div className="grid grid-cols-2 md:flex gap-4">
                    ...
                    <button onClick={handleBackToInvoiceList} className="flex px-3 py-2 rounded-full bg-gray-600 hover:bg-gray-500 col-span-2">
            ...
            <div className="bg-[#0B192C] rounded-lg p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-8 mb-6 sm:mb-8">
                    <div>
                ...
                <div className="bg-[#1E3E62] rounded-lg overflow-hidden">
                    <div className="p-8">
